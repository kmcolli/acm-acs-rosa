...
Click on *Copy Command*. This will copy a command to register your cluster with ACM to your clipboard.

image::images/acm-images/acm-import-rosa-copy-command.png[]


[start=4]
Next, log into your ROSA cluster.  Navigate to your ROSA Workshop environment and the beginning Environment Setup section, and ssh into the bastion.
