...
Try to deploy an Application on ACM using the ApplicationSet method. (Hint: This will require the OpenShift GitOps (ArgoCD) operator to be installed on the local cluster.) What do you see in the ArgoCD console after you do this?
