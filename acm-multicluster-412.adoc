...
* Your AWS Keys (from your workshop environment homepage)
* An AWS S3 bucket
* Your ROSA workshop bastion host

=== Create the S3 Bucket

* Start by logging into your ROSA workshop bastion host. See https://github.com/rh-mobb/rosa-workshop-acm-acs/blob/main/acm-multicluster-412.adoc#logging-into-your-rosa-cluster[Logging into your ROSA cluster] from earlier in the workshop if you need help.
